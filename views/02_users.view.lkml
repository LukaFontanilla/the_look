view: users {
  ...
  dimension: first_name {
    hidden: yes
    sql: CONCAT(UPPER(SUBSTR(${TABLE}.first_name,1,1)), SUBSTR(${TABLE}.first_name,2)) ;;

  }

  dimension: last_name {
    hidden: yes
    sql: CONCAT(UPPER(SUBSTR(${TABLE}.last_name,1,1)), SUBSTR(${TABLE}.last_name,2)) ;;
  }
  ...
  dimension: email {
    ...
    link: {
      ...
      url: "/dashboards/thelook_event_2::customer_lookup?Email={{ value | encode_uri }}"
