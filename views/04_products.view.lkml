view: products {
  ...
  dimension: brand {
    ...
    link: {
      ...
      #url: "/dashboards/thelook_event_2::brand_analytics_web__transactional?Brand%20Name={{ value | encode_uri }}"
      #url: "http://www.google.com/search?q=site:facebook.com+{{ value | encode_uri }}+clothes&btnI"
      url: "https://{{department._value | encode_uri}}/thelook_event_2/brand_analytics_web__transactional?Brand%20Name={{ value | encode_uri }}"
