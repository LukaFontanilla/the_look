view: order_items_share_of_wallet {
  ...
  measure: item_share_of_wallet_within_brand {
    ...
    sql: 100.0 *  ${total_sale_price_this_item}*1.0 / (CASE WHEN ${total_sale_price_this_brand} = 0 THEN NULL ELSE ${total_sale_price_this_brand} END) ;;
  }
  ...
  measure: item_share_of_wallet_within_company {
    ...
    #     view_label: 'Share of Wallet'
    type: number
    sql: 100.0 *  ${total_sale_price_this_item}*1.0 / (CASE WHEN ${order_items.total_sale_price} = 0 THEN NULL ELSE ${order_items.total_sale_price} END) ;;
  }
  ...
  measure: brand_share_of_wallet_within_company {
    ...
    #     view_label: 'Share of Wallet'
    type: number
    sql: 100.0 *  ${total_sale_price_brand_v2}*1.0 / ( CASE WHEN ${order_items.total_sale_price} = 0 THEN NULL ELSE ${order_items.total_sale_price} END) ;;
  }
}
