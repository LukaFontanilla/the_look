## This model should be kept up to date with the existing Redshift "thelook" demo
## on demo.looker.com
...
explore: events {
  ...
  # Commented out by Bruce - not part of Redshift thelook

  #join: event_facts {
  #  sql_on: ${events.event_id} = ${event_facts.id} ;;
  #  #X# sql_where:"${events.event_type} = 'Product'"
  #  relationship: one_to_one
  #}
